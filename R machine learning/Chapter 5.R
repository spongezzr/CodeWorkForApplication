...
library(caret)
set.seed(300)
index<-createDataPartition(credit$default, p=0.9, list = FALSE)
...
credit_model_i <- C5.0(credit_train_i[-17], credit_train_i$default)
...
credit_boost_pred10 <- predict(credit_boost10, credit_test, type="prob")
library(gmodels)
